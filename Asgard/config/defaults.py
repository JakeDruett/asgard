...
# Default forbidden imports for GAIA projects
DEFAULT_FORBIDDEN_IMPORTS = {
    "pika": "Use Triton message broker wrapper instead",
    "redis": "Use Triton cache wrapper instead",
    "sqlalchemy": "Use Lexicon database wrapper instead",
    "hvac": "Use Lexicon vault wrapper instead",
    "aioredis": "Use Triton async cache wrapper instead",
    "psycopg2": "Use Lexicon database wrapper instead",
    "pymysql": "Use Lexicon database wrapper instead",
    "mysql.connector": "Use Lexicon database wrapper instead",
}
