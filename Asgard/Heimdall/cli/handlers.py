...
def run_deps_export(args: argparse.Namespace, verbose: bool = False) -> int:
    ...
    try:
        ...
        if export_format == "dot":
            result = builder.export_dot(scan_path, output_path)
...
def run_future_leaks_analysis(args: argparse.Namespace, verbose: bool = False) -> int:
    """Placeholder for future/promise leak analysis (not yet implemented)."""
    print("Error: future-leaks scanner is not yet available.")
    return 1


def run_blocking_async_analysis(args: argparse.Namespace, verbose: bool = False) -> int:
    """Placeholder for blocking-in-async analysis (not yet implemented)."""
    print("Error: blocking-async scanner is not yet available.")
    return 1
