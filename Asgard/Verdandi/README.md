...
Verdandi is GAIA's runtime performance metrics package that calculates and analyzes performance data for web applications, databases, systems, networks, and caches. It provides statistical analysis tools including percentiles, Apdex scores, SLA compliance checking, and Core Web Vitals calculations.
