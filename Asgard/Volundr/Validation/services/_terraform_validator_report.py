"""
Terraform Validator report builder.

Report building extracted from terraform_validator_helpers.py.
"""
...
def build_report(
    ...
    """Build a ValidationReport from terraform validation results."""
