...
Embedded CSS for the web dashboard - layout, sidebar, cards, and rating styles.
Component styles (tables, badges, charts) are in _html_css_components.py.
"""

from Asgard.Dashboard.services._html_css_components import COMPONENT_CSS
...
EMBEDDED_CSS = _LAYOUT_CSS + COMPONENT_CSS
